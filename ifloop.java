...
//find even number
   ...
   public void sum()
  {
   ...
   if((a+b)==(a*b))
    {
    System.out.println("sum and product value  are equal");
    }
    else
    {
    System.out.println("sum and product value  are not equal");
    }
   }
 ...
 public void notmultiple()
  ...
  if(n%3!=0 && n%7!=0 )
  {
  System.out.println("The given numbers is not a multiple of 3 and 7");
  }
    else
    {
    System.out.println("The given numbers is  a multiple of 3 and 7");
    }
  }
}
